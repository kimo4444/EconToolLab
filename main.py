#####################################################################
#EconToolLab, is an application aimed at students majoring in Economics.
...
#used databases and some of the features of
...
###############################################
#REQUIREMENTS:
#matplotlib version 1.4 and higher
#ggplot
###############################################
...
class App:
 ...
 ###########################################################################
 #creating a nested dropdown using tk Menu and add_cascade to make it nested
 ###########################################################################
    ...
    ###########################################################################
     #creating a Toplevel window for Bivariate analysis consisting of two dropdowm menus
     #choice of two types of plots:scatter and bivariate using matplotlib
    ########################################################################### 
    def correlation():
      ####################
      #interface structure
    ...
    #########################################################
      def scatter():
        ...
        del values2[:]
       #################################################################################
       #finding a minimum and maximum year from database for selected economic indicator
       ##################################################################################
        ...
        ###########################################################################
        #choosing a minimum and maximum year between two chosen indicstaors to 
        #create same length arrays for correlation calculation
        ###########################################################################
      ...
      #################################################
        ...
        ###########################################################################
        #scatter plot using matplotlib scatter
        ###########################################################################
        ...
        ###########################################################################
        #2 economic variables simultaneously
        ###########################################################################
    ...
    def DescriptiveTools():
      ...
      ######################################################
      # calling function to create nested dropdown menu 
      ######################################################
    ...
    ###############################################
    #a help window explaining the use of the application
    ###############################################
    def about():
      ...
      listbox.insert(END, '    Econ Tool Lab is an application aimed at students majoring in Economics.\n \
        ...
        Press the Descriptive Statistics button in the main menu. Choose an economic indicator\
        you wish to analyze in the top dropdown menu. Click any checkboxes corresponding to the\
        statistical tool you wish to acquire. Choose the type of plot. Customize you plot if you wish.\
        Click submit button')
