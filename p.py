...
toolsFrame.grid(row=0, column=0, sticky="nsew")
toolsFrame.grid_rowconfigure(6, weight=1)
var = StringVar()
...
def query ():
  ...
  if checkedRange.get() == 1:
    ...
    rangeLabel.grid(column = 0, row = 13, sticky = W)
...
variance = Checkbutton(toolsFrame,  onvalue=1, variable = checkedVar, offvalue=0, text = 'Variance').grid(row = 1,column = 0, pady=(10,0), padx = (40,0), sticky = W)

std = Checkbutton(toolsFrame, variable = checkedStd, onvalue=1, offvalue=0, text = 'Std.Deviation').grid(row = 1, column = 1, columnspan = 1, pady=(10,0),  sticky= W)

mean = Checkbutton(toolsFrame, variable = checkedMean, onvalue=1, offvalue=0, text = 'Mean').grid(row = 2, column = 0, sticky = W, padx = (40,0), pady=(8,0))
median = Checkbutton(toolsFrame,  variable = checkedMed, onvalue=1, offvalue=0, text = 'Median').grid(row = 2, column = 1, sticky = W, pady=(8,0))


minValue = Checkbutton(toolsFrame,  variable = checkedMin, onvalue=1, offvalue=0, text = 'Minimum').grid(row = 3, column = 0, sticky = W, padx = (40,0), pady=(8,0))
maxValue = Checkbutton(toolsFrame, variable = checkedMax, onvalue=1, offvalue=0, text = 'Maximum').grid(row = 3, column = 1, sticky = W, pady=(8,0))

rangeValue = Checkbutton(toolsFrame,  variable = checkedRange, onvalue=1, offvalue=0, text = 'Range').grid(row = 4, column = 0, sticky = W, padx = (40,0), pady = (8,10))

startLabel = Label(toolsFrame, text = 'Start Year').grid(row = 5, column = 0, padx = (40,0),sticky = NW)
startYear = Entry(toolsFrame)
startYear.grid(row = 5, column = 1, sticky = NW)
endLabel = Label(toolsFrame, text = 'End Year').grid(row = 6, column = 0, padx = (40,0), sticky=NW)
endYear = Entry(toolsFrame)
endYear.grid(row = 6, column = 1, sticky = NW)
submitButton = Button(toolsFrame, text = 'Submit', width= 10, command = query)
submitButton.grid(row = 7, column = 1,  padx = (75,0), pady=(0,0), sticky=W)
...
canvas.get_tk_widget().grid(row = 14, column = 0, columnspan=10, rowspan=6, sticky = NW)
